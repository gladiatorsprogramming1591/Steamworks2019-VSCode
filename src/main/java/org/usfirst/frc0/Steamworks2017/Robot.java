...
public class Robot extends IterativeRobot {
	...
	//creating network tables entries
	...
	public void robotInit() {
		...
		//get networktable and entries we're looking for
    	...
    	autoChooser.addObject("LeftStart", new LeftStart());
    	autoChooser.addObject("MidStart", new MidStart());
		 */
	...
	//creating values for network tables
	double netX = 0;
	double netY = 0;
	...
	public void teleopPeriodic() {
		...
		//set values
		xEntry.setDouble(netX);
		yEntry.setDouble(netY);
		netX += 0.05;
		netY += 1.0;
	}
